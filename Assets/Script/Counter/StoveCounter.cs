...
public class StoveCounter : BaseCounter, IHasProgress
{
        ...
        if (HasKitchenObject())
        {
            switch (state)
            {
                ...
                case State.Frying:
                    ...
                    {
                        progressNomarlize = fryingTimer / fryingRecipeSO.fryingTimerMax
                    });
                ...
                case State.Fried:
                    ...
                    OnProgressChanged?.Invoke(this, new IHasProgress.OnProgressChangedEventArgs
                    {
                        progressNomarlize = burningTimer / burningRecipeSO.burningTimerMax
                    });
    ...
    public override void Interact(Player player)
    {
        if (!HasKitchenObject()) // no kitchen object
        {
            ...
            {
                if (HasRecipeWithInput(player.GetKitchenObject().GetKitchenObjectSO())) // carrying smthing that can cook
                {
